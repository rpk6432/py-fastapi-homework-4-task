...
async def register_user(
    ...
    Args:
        ...
        settings (BaseAppSettings): Application settings for URL configuration.
    ...
    try:
        ...
        activation_link = (
            f"{settings.FRONTEND_BASE_URL}/accounts/activate/{activation_token.token}/"
        )
...
async def request_password_reset_token(
    ...
    reset_link = (
        f"{settings.FRONTEND_BASE_URL}/accounts/reset-password/{reset_token.token}/"
    )
    background_tasks.add_task(
